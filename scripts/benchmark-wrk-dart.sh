...
echo "=========================================="
echo "Dart Vaden - WRK Benchmark Suite"
echo "=========================================="
echo ""

# Configuration
SERVICE="${SERVICE:-dart-vaden}"
...
echo "  Dart runtime provides excellent performance"
echo "  AOT compilation ensures peak performance"
echo "  Isolates enable true parallelism"
echo ""

echo "Key Performance Characteristics:"
echo "  1. AOT compilation to native code"
echo "  2. Sound null safety (compile-time checks)"
echo "  3. Isolates for parallelism (no GIL)"
echo "  4. Generational garbage collection"
echo ""
...
echo "  Save results to file: ./benchmark-wrk-dart.sh > results.txt"
echo ""
