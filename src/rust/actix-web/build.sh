...
# Build script for Rust Actix Web
# Usage: ./build.sh [target]

set -e

TARGET=${1:-"local"}
IMAGE_NAME="benchmark/rust-actix-web"
IMAGE_TAG="latest"

echo "=========================================="
echo "Rust Actix Web - Build Script"
echo "=========================================="
echo "Target: $TARGET"
...
case $TARGET in
    "local")
        ...
        cargo build --release
        print_success "Build complete: ./target/release/benchmark-actix"
        ;;
    ...
    *)
        ...
        echo ""
        echo "Targets:"
        echo "  local        - Build for local development (./target/release/benchmark-actix)"
        echo "  docker       - Build Docker image (benchmark/rust-actix-web:latest)"
