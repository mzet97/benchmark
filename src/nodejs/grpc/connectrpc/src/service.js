...
/**
 * BenchmarkService implementation for ConnectRPC.
 * ConnectRPC service methods receive (request) and return the response directly.
 * Errors are thrown as ConnectError instances.
 */
const benchmarkService = {
  ...
  async getUser(request) {
    ...
    if (result.rows.length === 0) {
      throw new ConnectError(`User with id ${id} not found`, Code.NotFound);
    }
