# Deno Fresh - Benchmark API

REST API benchmark implementation using Deno with Fresh framework.

## Tech Stack

- **Runtime**: Deno 2.0
- **Framework**: Fresh (Deno.serve-based)
...
# Docker
./build.sh docker
docker run -p 3000:3000 benchmark/deno-fresh:latest
