...
# Build script for C# .NET 9 Minimal API
# Usage: ./build.sh [target]

set -e

TARGET=${1:-"local"}
IMAGE_NAME="benchmark/csharp-minimal-api"
IMAGE_TAG="latest"

echo "=========================================="
echo "C# .NET 9 Minimal API - Build Script"
echo "=========================================="
echo "Target: $TARGET"
...
case $TARGET in
    "local")
        ...
        print_success "Build complete: ./bin/Release/net9.0/benchmark-api"
        ;;
    ...
    *)
        ...
        echo ""
        echo "Targets:"
        echo "  local        - Build for local development (./bin/Release/net9.0/benchmark-api)"
        echo "  docker       - Build Docker image (benchmark/csharp-minimal-api:latest)"
