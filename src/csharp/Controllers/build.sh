...
# Build script for C# .NET 9 Controllers API
# Usage: ./build.sh [target]

set -e

TARGET=${1:-"local"}
IMAGE_NAME="benchmark/csharp-rest-controllers"
IMAGE_TAG="latest"

echo "=========================================="
echo "C# .NET 9 Controllers API - Build Script"
echo "=========================================="
echo "Target: $TARGET"
...
case $TARGET in
    "local")
        ...
        print_success "Build complete: ./bin/Release/net9.0/Controllers"
        ;;
