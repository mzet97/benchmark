...
func (d *DB) GetUser(ctx context.Context, id int) (*model.User, error) {
...
func (d *DB) GetComplexOrders(ctx context.Context, days int) ([]*model.UserOrderStats, error) {
	...
	var results []*model.UserOrderStats
	for rows.Next() {
		var s model.UserOrderStats
